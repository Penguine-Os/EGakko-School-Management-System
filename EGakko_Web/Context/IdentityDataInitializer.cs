    ...
    public class IdentityDataInitializer
    {
        ...
        public static async Task SeedIdentityUsers(UserManager<CustomUser> userManager, RoleManager<IdentityRole> roleManager, ApplicationDbContext applicationDbContext)
        {
            ...
            List<CustomUser> customUserStudent = new List<CustomUser>
                            ...
                            new CustomUser
                                {
                                    Email= "morningwood19@freewebs.com",
                                    FName= "Morning",
                                    LName= "Star",
                                    Street= "Randy",
                                    HouseNumber= 2169,
            ...
            //DateTime endDate = new DateTime(2022, 8, 30);
            ...
            //        IdentityResult result =  userManager.CreateAsync(cStudent, password).Result;
            //        if (result.Succeeded)
            //        {
            //            var date = GenerateRandomDate(startDate, endDate);
            //            IdentityRole role =  roleManager.FindByNameAsync("student").Result;
            //            userManager.AddToRoleAsync(cStudent, role.Name).Wait();
            //            var student = new Student(cStudent.Id, date);
            ...
            //        if (result.Succeeded)
            //        {
            //            IdentityRole role = await roleManager.FindByNameAsync("defaultUser");
